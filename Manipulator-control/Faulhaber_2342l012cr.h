...
#define FAULHABER_2342L012CR_POSITION_KP 50.0 //7.5
#define FAULHABER_2342L012CR_POSITION_KI 0.1 //0.0
#define FAULHABER_2342L012CR_POSITION_KD 0.0

#define FAULHABER_2342L012CR_VElOCITY_KP 1250.0 //7.5
#define FAULHABER_2342L012CR_VElOCITY_KI 100.0 //7.5
